...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { BewlyAppProvider } from './composables/useAppProvider'
  import('./composables/useAppProvider')
  // @ts-ignore
  export type { FilterType } from './composables/useFilter'
  import('./composables/useFilter')
}
